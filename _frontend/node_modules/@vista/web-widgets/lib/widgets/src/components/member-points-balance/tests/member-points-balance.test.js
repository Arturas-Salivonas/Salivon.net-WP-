...
import { MemberPointsBalance } from '../member-points-balance';
import { defaultMemberPointsBalanceDisplayText } from '../types/display-text';
describe('MemberPointsBalance', function () {
    var testProps;
    beforeEach(function () {
        testProps = {
            loyaltyStore: loyaltyStoreInstance,
            displayText: defaultMemberPointsBalanceDisplayText
        };
    ...
    it('should not render when the loading indicator is disabled', function () {
        ...
        compareToSnapshot(React.createElement(MemberPointsBalance, __assign({}, testProps)));
    });
    ...
    it('should not render without member balance', function () {
        var memberDetails = __assign({}, exampleLoyaltyMember, { memberBalance: undefined });
        loyaltyStoreInstance.setData({
            authTokenPayload: exampleMxAuthTokenPayload,
    ...
    it('should render without expiry points details', function () {
        var memberDetails = __assign({}, exampleLoyaltyMember, { expiryPoints: undefined });
        loyaltyStoreInstance.setData({
            authTokenPayload: exampleMxAuthTokenPayload,
            signedInMemberDetails: memberDetails
        });
...
//# sourceMappingURL=member-points-balance.test.js.map