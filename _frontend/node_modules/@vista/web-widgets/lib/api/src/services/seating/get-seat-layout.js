...
export function getSeatLayout(showtimeId) {
    return __awaiter(this, void 0, void 0, function () {
        var isSeatFirstOrdering, orderId;
        return __generator(this, function (_a) {
            isSeatFirstOrdering = configurationStoreInstance.data.ticketing.isSeatFirstOrdering;
            if (isSeatFirstOrdering) {
                return [2 /*return*/, seatingService.loadSeatLayoutForShowtime(showtimeId)];
            }
            else {
                orderId = orderStoreInstance.selectors.getOrderId();
                if (!orderId) {
                    throw new Error('Cannot fetch a seat layout in ticket-first ordering mode without an orderId');
                }
                return [2 /*return*/, seatingService.loadSeatLayoutForOrder(orderId, showtimeId)];
            }
            return [2 /*return*/];
        });
    });
}
//# sourceMappingURL=get-seat-layout.js.map